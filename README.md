...
<!-- Please read https://github.com/linuxserver/docker-sickgear/blob/develop/.github/CONTRIBUTING.md -->
...
[![LSIO CI](https://img.shields.io/badge/dynamic/yaml?color=94398d&labelColor=555555&logoColor=ffffff&style=for-the-badge&label=CI&query=CI&url=https%3A%2F%2Fci-tests.linuxserver.io%2Flinuxserver%2Fsickgear%2Fdevelop%2Fci-status.yml)](https://ci-tests.linuxserver.io/linuxserver/sickgear/develop/index.html)
...
Simply pulling `lscr.io/linuxserver/sickgear:develop` should retrieve the correct image for your arch, but you can also pull specific arch images via tags.
...
services:
  sickgear:
    image: lscr.io/linuxserver/sickgear:develop
...
* Image version number:
    ...
    ```bash
    docker inspect -f '{{ index .Config.Labels "build_version" }}' lscr.io/linuxserver/sickgear:develop
    ```
...
* Update the image:
    ...
    ```bash
    docker pull lscr.io/linuxserver/sickgear:develop
    ```
...
docker build \
  --no-cache \
  --pull \
  -t lscr.io/linuxserver/sickgear:develop .
```
...
* **10.10.22:** - Rebase develop branch to Alpine 3.16, migrate to s6v3, build unrar from source.
* **31.01.21:** - Add unrar.
